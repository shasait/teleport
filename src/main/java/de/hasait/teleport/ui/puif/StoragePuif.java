...
@Service
public class StoragePuif extends AbstractToOnePuiFactory<StoragePO, StorageRepository, Void> {

    public StoragePuif(StorageRepository repository) {
        super(StoragePO.class, () -> null, repository);
    }
